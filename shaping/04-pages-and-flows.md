...
| --- | --- | --- | --- |
| 记录 | 完成今天、回看历史、补录或临时记录 | 今日、历史记录、日期切换、补剂柜选取、补录 | 基础今日/记录已实现；临时选取缺失 |
...
| 补剂柜 | 管理产品与库存 | 列表、详情/编辑、批次、成本、笔记、产品 AI | 基础列表/详情/补货已实现；其余部分缺失 |
...
| 补剂柜选取 | 临时记录非计划项目 | 可用产品、批次与余量 | 选择产品和数量 | 今日 / 记录结果 |
...
| 补剂柜 | 查找和管理产品 | 状态、余量、预计耗尽、临期 | 搜索、筛选、新增、进入详情 | 底栏“补剂柜” / 详情 |
| 产品详情/编辑 | 管理单一产品 | 基础资料、图片、计划、成分、批次、风险 | 编辑、补货、停用/删除、进入 AI/笔记 | 补剂柜/今日 / 各子页 |
